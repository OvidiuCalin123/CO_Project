...
public class Buttons {
    ...
    public void back(StackPane randomWriteMainScreen, BorderPane pane){
        EventHandler<ActionEvent> event = e -> {
            randomWriteMainScreen.toBack();
        };

        buttonBuilder("Back", -280, -50, randomWriteMainScreen, event, pane);

    }


    public void addButtonsToScreen(StackPane randomWriteMainScreen, BorderPane pane){
